            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                <p>Copyright © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved | <span style="color: white;">Website Designed by: <a href="https://techenovative.com/"><span style="color: white;">Ekram & Jahir</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
